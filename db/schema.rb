...
ActiveRecord::Schema.define(version: 2019_09_04_190939) do
  ...
  create_table "our_mails", force: :cascade do |t|
    t.string "message_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_our_mails_on_user_id"
  end
  ...
  add_foreign_key "our_mails", "users"
